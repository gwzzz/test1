...
// ---------- 素材 ----------
const IMG = {
  hero: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_b595ff20-d6c9-443f-80d2-5dfb5fd90893.jpeg?sign=1821511797-08f03540c8-0-211f1aaab3bcc276add4fb261e6263baf185a96ee6665c350029df88d278ee98',
  fox: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_fef078c8-5cfb-49b0-806a-27d208a13bd1.jpeg?sign=1821511797-da5922d401-0-e613406fb624512117b7225fddc3ef885ca25423f8f394e0e446f335100c5db3',
  whale: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_36ee6414-0e61-410b-8ce4-404b40e559cd.jpeg?sign=1821511797-0880e54fa5-0-87513fec4e09bc4d10c4c2f4a2a454c7c02402eba751e777d3fd2a6383ea01ce',
  seasons: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_65e87e22-89ba-4d2e-8b70-5162665d8ca9.jpeg?sign=1821511798-bb62f81047-0-cc9fd8d92ab54f3d07f1cebc719ad8c2ab69f264153b367b59fa6549616e03a5',
  cloud: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_8593f13e-7804-4c30-b617-50c2c6faca91.jpeg?sign=1821511797-fc4c5b4a1c-0-d3bb20fa787bccdecf7333260fe26a3fa10d1c077cf28568ed729dd099ba5588',
  craft: 'https://coze-coding-project.tos.coze.site/coze_storage_7687877259167825963/image/generate_image_3a79aef6-6216-402b-9491-ca2620b92303.jpeg?sign=1821511798-8efcdc8724-0-2d59112af1a8534df42b2d4152c00d99c60b14e686cc73fc735065f4d0aadfde',
};
...
const books: Book[] = [
  {
    ...
    en: 'The Lantern Fox',
    author: '纸间 · 阿末',
    desc: '一只在雨夜里为迷路的旅人点亮灯笼的小狐狸，关于善意与陪伴的最温柔一课。',
  },
  {
    img: IMG.whale,
    title: '鲸鱼的星空',
    en: 'The Star Whale',
    author: '纸间 · 苏黎',
    desc: '会唱歌的鲸鱼驮着满天星辰游过深海，教孩子看见黑暗里的光。',
  },
  {
    img: IMG.seasons,
    title: '四季的茶杯',
    en: 'A Cup for Seasons',
    author: '纸间 · 十一',
    desc: '蜗牛与花草围着冒热气的茶杯，认真过好每一个小而具体的日子。',
  },
  {
    img: IMG.cloud,
    title: '我想慢慢长大',
    en: 'Cloud, Please Wait',
    author: '纸间 · 阿末',
    desc: '不爱长高的小云朵和它的小男孩朋友，一场关于成长与告别的对话。',
  },
];
...
// ---------- 区块构造 ----------
function navHtml(user: { online: boolean }): string {
  return `
  <header id="siteNav" class="fixed inset-x-0 top-0 z-50 transition-all duration-500">
    <nav class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
      <a href="#top" class="flex items-center gap-2">
        <span class="text-2xl">📚</span>
        <span class="serif-title text-lg font-bold tracking-wide">纸间故事</span>
      </a>
      <div id="menuLinks" class="hidden items-center gap-8 text-sm text-ink-soft md:flex">
  ...
  <section id="top" class="relative overflow-hidden pt-28 md:pt-32">
    ...
    <div class="relative mx-auto grid max-w-6xl items-center gap-10 px-6 pb-20 md:grid-cols-2 md:pb-28">
      <div class="space-y-7">
        ...
        <h1 class="serif-title text-4xl font-black leading-tight md:text-6xl">
          把故事揉进纸里，<br/>送给长大后的你
        </h1>
        <p class="max-w-md leading-relaxed text-ink-soft">
          我们是一家小小的绘本工作室，画温柔的水彩，做有温度的手作文创。愿每一本书，都像一盏床头小灯。
        </p>
      ...
      <div class="hero-scene relative">
        <div class="img-zoom overflow-hidden rounded-[2rem] shadow-lift">
          <img src="${IMG.hero}" alt="街角的绘本书店" class="aspect-[3/2] w-full object-cover" fetchpriority="high" />
        </div>
        ...
        ${books
          ...
          <article class="reveal reveal-delay-${(i % 4) + 1}">
            <div class="img-zoom card-lift overflow-hidden rounded-3xl shadow-paper">
              <img src="${b.img}" alt="${b.title}" class="aspect-[3/4] w-full object-cover" loading="lazy" />
            </div>
            <div class="mt-4 px-1">
  ...
  <section id="craft" class="bg-paper-deep/60 py-20 md:py-28">
    <div class="mx-auto max-w-6xl px-6">
      ...
      <div class="reveal img-zoom mb-10 overflow-hidden rounded-[2rem] shadow-paper">
        <img src="${IMG.craft}" alt="绘本文创产品陈列" class="max-h-[22rem] w-full object-cover" loading="lazy" />
      </div>
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ${products
          .map(
            (p, i) => `
          <div class="card-lift reveal reveal-delay-${(i % 4) + 1} rounded-3xl border border-ink/5 bg-paper p-6 shadow-sm">
      ...
      <div class="grid items-center gap-12 md:grid-cols-2">
        ...
        <div class="reveal reveal-delay-1 space-y-5">
          <figure class="img-zoom overflow-hidden rounded-[2rem] shadow-paper">
            <img src="${IMG.whale}" alt="创作手记插画" class="aspect-[4/3] w-full object-cover" loading="lazy" />
          </figure>
          <div class="grid grid-cols-3 gap-4 text-center">
            <div class="rounded-2xl bg-paper-deep/60 py-5">
              <p class="serif-title text-2xl font-black">36</p>
              <p class="text-xs text-ink-soft">期手记</p>
            </div>
            <div class="rounded-2xl bg-paper-deep/60 py-5">
              <p class="serif-title text-2xl font-black">8</p>
              <p class="text-xs text-ink-soft">期工坊</p>
            </div>
            <div class="rounded-2xl bg-paper-deep/60 py-5">
              <p class="serif-title text-2xl font-black">∞</p>
              <p class="text-xs text-ink-soft">份童心</p>
            </div>
          </div>
        </div>
      </div>
...
function footerHtml(): string {
  ...
  <footer class="border-t border-ink/5 py-12">
    <div class="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 text-center md:flex-row md:text-left">
      ...
      <p class="text-xs text-ink-soft/70">© 2024 纸间故事工作室 · 温柔出品</p>
    </div>
  </footer>`;
}
...
function bindInteractions(): void {
  ...
  // 加入蓝子
  const addBtns = document.querySelectorAll<HTMLButtonElement>('.add-btn');
  addBtns.forEach((btn) => {
  ...
  // 订阅表单
  const subForm = document.getElementById('subForm') as HTMLFormElement | null;
  const subMsg = document.getElementById('subMsg');
  subForm?.addEventListener('submit', (e) => {
    e.preventDefault();
    const email = (document.getElementById('subEmail') as HTMLInputElement).value;
    if (subMsg) {
      subMsg.textContent = `已收到你的来信地址 ${email}，我们月底见 🌙`;
